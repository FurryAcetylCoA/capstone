...
DEP_LOONGARCH =
DEP_LOONGARCH += $(wildcard arch/LoongArch/LoongArch*.c)
...
LIBOBJ += $(LIBOBJ_TRICORE) $(LIBOBJ_ALPHA) $(LIBOBJ_LOONGARCH)
...
TESTS += test_mos65xx.static test_wasm.static test_bpf.static test_alpha.static test_loongarch.static
